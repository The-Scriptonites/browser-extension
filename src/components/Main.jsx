...
export default function Main({ isDarkMode }) {
  let [extensions, setExtensions] = useState(data);
  ...
  function handleExtensionToggle(name) {
  ...
  let sortedItems;
  if (statusFilter === "all") sortedItems = extensions;
  if (statusFilter === "active")
    sortedItems = extensions.filter((item) => item.isActive);
